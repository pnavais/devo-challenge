...
import com.github.pnavais.ex1.core.PalindromeChecker;
...
public class PalindromeCheckerApp implements Runnable {
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new PalindromeCheckerApp())
