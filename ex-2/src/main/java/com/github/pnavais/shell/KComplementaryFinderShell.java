...
import com.github.pnavais.core.KComplementaryFinder;
...
public class KComplementaryFinderShell implements Runnable {
        ...
        if (Objects.isNull(input) || Objects.isNull(k)) {
            ...
            while (Objects.isNull(this.input)) {
                ...
                try {
                    ...
                    System.out.println(Colorize.fail("The specified array is not valid"));
                }
            }
            ...
            while (Objects.isNull(this.k)) {
                ...
                try {
                    ...
                    System.out.println(Colorize.fail("The value is not a valid integer"));
                }
            }
            System.out.println();
        }
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new KComplementaryFinderShell())
